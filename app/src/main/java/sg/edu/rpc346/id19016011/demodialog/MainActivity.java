package sg.edu.rpc346.id19016011.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo4 = findViewById(R.id.buttonDate);
        btnDemo5= findViewById(R.id.buttonTime);
        btnExercise = findViewById(R.id.buttonExercise);
        tvDemo2 = findViewById(R.id.textViewDemo2);
        tvDemo3 = findViewById(R.id.textViewDemo3);
        tvExercise = findViewById(R.id.textViewExercise);
        tvDemo4 = findViewById(R.id.buttonDate);
        tvDemo5 = findViewById(R.id.textViewTime);
        ...
        btnExercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Obtain the UI component in the input.xml layout
                //It needs to be defined as "final", so that it can used in the onClick() method later
                final EditText etInput1 = viewDialog.findViewById(R.id.editTextEx1);
                final EditText etInput2 = viewDialog.findViewById(R.id.editTextEx2);
        ...
        btnDemo4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Creeate the Listener to set the date
